...
### webエンジニア志望の学生
### 茨城県石岡市出身
現在はバックエンド(Javaなど)を主に学校で学び、フロントエンド(TypeScript、Reactなど)を独学で学んでいます。
...
[![Repository URL1][badge-url]][repository1]
...
コミュケーションアプリのDiscordの拡張機能的な立ち位置でこんなアプリがあったら良いなと思い開発を進行しています。
